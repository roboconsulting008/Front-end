        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-end animate-fadeInRight">
            ...
            <div className="relative p-1 rounded-3xl shadow-2xl w-4/5 transform rotate-4 transition-all duration-500 animate-borderGlitter">
              ...
              <div className="sparkle-ball"></div>
            ...
            <div className="absolute -right-4 -bottom-4 w-72 h-72 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full opacity-10 blur-3xl -z-10"></div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .animate-borderGlitter {
          background: linear-gradient(90deg, 
            ...
            #3b82f6 100%);
          background-size: 300% 300%;
          animation: borderGlitter 10s linear infinite;
        }
